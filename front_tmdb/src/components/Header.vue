    ...
    <nav class="max-w-screen-lg m-auto flex justify-between px-2 py-4">
      ...
      <div class="flex items-center justify-center">
        <div class="relative">
          ...
          <input v-model="searchInput" @input="handleInput" class="block w-full bg-[#EBE6F0] p-2 rounded-lg border-[#EBE6F0]" type="text" name="" id="" placeholder="Buscar..." />
        </div>
      </div>
    </nav>
  </header>
...
<script setup>
  ...
  function search (query) {
    movieStore.searchMoviesAction(query);
  }
</script>